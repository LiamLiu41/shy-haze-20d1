...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/shy-haze-20d1
```

A live public deployment of this template is available at [https://shy-haze-20d1.templates.workers.dev](https://shy-haze-20d1.templates.workers.dev)
